...
$$
i(t) = C\dfrac{du(t)}{dt}\leftrightarrow U(s)=\dfrac{sC}{I(s)}+\dfrac{u(0^-)}{s}
$$
...
$$
x[-n]\leftrightarrow X(a^{-1}z),ROC=R^{-1}
$$
...
x_{(k)}[n] = \left\{\begin{matrix}
 x[r], & n=rk\\
 0, & n\neq rk
\end{matrix}\right.\leftrightarrow X(z^k)
$$
...
$$
r^n\sin(w_0n)u[n]\leftrightarrow\dfrac{r(\sin w_0)z^{-1}}{1-2r(\cos w_0)z^{-1}+r^2z^{-2}},|z|>1
$$
