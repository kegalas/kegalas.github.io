...
你可能会问，我知道光有颜色，但是亮度怎么办？简单的想法是，一个颜色的0.9倍亮度，就是把每个分量都乘以0.9。更正确的想法可以参考[Tone-mapping简述](../tone-mapping简述/#tone-mapping的作用)一文中提到的$L = 0.2959R + 0.5870G + 0.1140B$，然后计算$T=0.9L$，然后进行颜色恢复$C' = \left(C/L\right)^s T$。
