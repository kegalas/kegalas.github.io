...
求解的方法一般会用梯度下降法。见[最优化理论学习笔记](../水文-最优化理论学习笔记/#最速下降法)
...
当且仅当函数取得最小值$0$时，有最优的$w^*$。求解过程可以用梯度下降法。见[最优化理论学习笔记](../水文-最优化理论学习笔记/#最速下降法)
...
前置知识为[人工智能概论笔记](../水文-人工智能概论笔记/#模糊计算和模糊推理)
